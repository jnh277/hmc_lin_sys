...
""" This demonstrates Bayesian estimation of linear state space models using HMC
    This script rums the code to estimate the model and save the model and results to the
    file 'lssm_traces.pickle'. The results can then be plotted using "additional_example2_lssm_plot.py"
...
# specific data path
data_path = 'data/additional_example2_lssm.mat'
