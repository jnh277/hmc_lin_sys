...
"""
    ...
    Plots the model estimated by additional_example3_sysid.py, these plots correspond to estimating a
    6th order linear state space model.
     ...
     matlab script matlab/additional_example3_controller_phase_margin.m"""
