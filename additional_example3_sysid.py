...
"""
    ...
    Runs the HMC estimation for a 6th order linear state space model using data generated by
    matlab/additional_exasmple3_controller_generate_data.m """
""" This script runs the estimation and saves the estimated model to 'ctrl_sysid_traces2.pickle',
    so that it can be plotted using additonal_example3_plotsysid.py which also converts the samples from state
