...
with open('results/lssm_traces.pickle', 'wb') as file:
...
plt.subplot(1, 2, 2)
plt.plot(y_est, linewidth=1)
plt.plot(yhat_mean, linewidth=1)
plt.plot(yhat_upper_ci, '--', linewidth=1)
plt.plot(yhat_lower_ci, '--', linewidth=1)
plt.title('measurement estimates')
plt.legend(('true', 'mean', 'upper CI', 'lower CI'))
plt.xlim([1000,1050])
plt.ylim([-0.9,-0.5])
