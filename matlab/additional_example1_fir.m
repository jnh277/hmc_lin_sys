...
% fir model data generation
% the hmc system identification can then be run using additional_example1_fir.py
...
save('../data/additional_example1_fir.mat','y_estimation', 'u_estimation', 'y_validation',...
