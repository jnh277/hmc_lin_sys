...
fit = model.sampling(data=stan_data, init=init_function, iter=20, chains=4,control=control)
...
plt.subplot(1,1,1)
plt.plot(h_traces[:,0,100],Mq_traces,'o')
plt.xlabel('state 1 at k=100')
plt.ylabel('M')
plt.show()

plt.subplot(1,1,1)
plt.plot(h_traces[:,1,300],Kq_traces,'o')
