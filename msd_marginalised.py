...
"""Estimates a msd by marginalising over the states."""
import pystan
import numpy as np
...
model = pystan.StanModel(file='stan/msd_margin.stan')
...
fit = model.sampling(data=stan_data, init=init_function, iter=5000, chains=1,control=control)
